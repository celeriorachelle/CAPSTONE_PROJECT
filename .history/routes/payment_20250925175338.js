...
const paymentType = option === "down" ? "downpayment" : "fullpayment";
const truncatedPaymentType = paymentType.substring(0, 20);
...
await db.query(
  ...
  [normalizedBookingId, normalizedUserId, amount, truncatedPaymentType]
);
